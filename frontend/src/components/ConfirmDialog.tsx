  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="w-full max-w-sm rounded-2xl border border-white/[0.08] bg-ink-900 p-6 shadow-film outline-none"
      >
        <h2 id="confirm-dialog-title" className="font-display text-lg font-semibold text-zinc-50">
          {title}
        </h2>
