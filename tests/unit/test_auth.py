"""Adversarial, fully-offline tests for :mod:`cinemory.auth`.
...
Google cert fetch (``cinemory.auth._default_key_source``); tests wire a fake
...
from cinemory.auth import AuthError, uid_from_authorization, verify_firebase_id_token

PROJECT_ID = "cinemory-test-project"
...
def _generate_keypair_and_cert() -> tuple[str, str]:
    ...
    name = x509.Name([x509.NameAttribute(NameOID.COMMON_NAME, "cinemory-test")])
