#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# Stage Cinemory's live secrets into Google Secret Manager. Run this once, and
...
echo "  deploy:  CINEMORY_MODE=live B2_BUCKET_NAME=cinemory B2_S3_ENDPOINT=... bash deploy/deploy-cloudrun.sh"
